...
use EmissorNfse\Providers\Ginfes\V1_00\Request\ConsultarNfseRequest;
...
$request = new ConsultarNfseRequest();

//$request->setInscricaoMunicipalPrestador(1234);
$request->setCnpjPrestador('40409711000139');
$request->setNumeroNfse('1');
